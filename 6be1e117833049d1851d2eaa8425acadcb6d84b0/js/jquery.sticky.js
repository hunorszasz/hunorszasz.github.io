    ...
    var defaults = {
        ...
        scroller = function() {
            var scrollTop = $window.scrollTop(),
                ...
                extra = (scrollTop > dwh) ? dwh - scrollTop : -150;
            ...
            for (var i = 0, l = sticked.length; i < l; i++) {
                ...
                heightFirstElement = heightFirstElement.toString().concat("px");
                heightRestElements = heightRestElements.toString().concat("px");
                var minus = "-";
                negHeightFirstElement = minus.concat(heightFirstElement);
                negHeightRestElements = minus.concat(heightRestElements);
                var allAnchorElements = document.querySelectorAll(".anchor");
                for (let i = 0; i < allAnchorElements.length; i++) {
                    if (i == 0 || i == 1) {
                        allAnchorElements[i].style.height = heightFirstElement;
                        allAnchorElements[i].style.marginTop = negHeightFirstElement;
                    } else {
                        allAnchorElements[i].style.height = heightRestElements;
                        allAnchorElements[i].style.marginTop = negHeightRestElements;
                    }
        ...
        resizer = function() {
            ...
            var asiteTopLogo = document.querySelectorAll(".site-top-logo");
            asiteTopLogo = asiteTopLogo[0];
            str_newSiteTopLogoTop = (asiteTopLogo.offsetHeight / -2).toString();
            asiteTopLogo.style.top = str_newSiteTopLogoTop.concat("px");
            //end-----------------------
